...
async function seedRealData() {
  ...
  const timelines = [
    {
      ...
      description:
        "2nd Year (3rd Semester) · Expected Graduation: 2029 · [ADD COLLEGE NAME]",
      timeline: { from: "2025", to: "2029" },
    },
    {
      title: "Foundations in Programming & Core CS",
      description:
        "Started building programming foundations in Java, core Data Structures fundamentals, and web development basics.",
      timeline: { from: "2025", to: "2025" },
    },
    {
      title: "Advanced DSA, Data Systems & Machine Learning",
      description:
        "Focused on Advanced DSA, Python (NumPy, Pandas), relational database architecture with PostgreSQL/SQL, full-stack engineering, and introductory Machine Learning.",
      timeline: { from: "2026", to: "Present" },
    },
    {
      title: "Planned Focus: Deep Learning, PyTorch & Production AI",
      description:
        "Planned development focusing on Deep Learning, PyTorch, MLOps, system design, and building reliable production AI systems.",
  ...
  const skills = [
    ...
    },
    {
      ...
      svg: {
        public_id: "skill_dsa",
        url: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/thealgorithms/thealgorithms-original.svg",
      },
    },
    {
  ...
  const tools = [
    ...
    },
    {
      name: "Cloudinary",
      svg: {
        public_id: "tool_cloudinary",
        url: "https://res.cloudinary.com/cloudinary/image/upload/dpr_auto/w_80/v1/logo/for_white_bg/cloudinary_icon_for_white_bg.svg",
      },
    },
  ];
  ...
  const projects = [
    {
      title: "Krivio",
      description:
        "A full-stack product built as part of my journey in software engineering, focused on creating a polished real-world application rather than a basic tutorial project.",
    ...
    },
    {
      title: "Gitapath",
      description:
        "A software project focused on building a practical user-facing product while strengthening full-stack development, backend architecture, and database integration.",
    ...
    },
    {
      title: "Truva",
      description:
        "A full-stack project developed to strengthen practical engineering skills across frontend development, backend APIs, database integration, and application architecture.",
      stack: "Full-Stack / Product Project",
      technologies: "React, Node.js, Express, PostgreSQL",
      deployed: "In Development",
      gitRepoLink: "https://github.com/jharajiv315",
